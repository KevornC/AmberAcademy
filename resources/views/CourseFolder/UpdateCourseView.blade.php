...
<div class="w-full bg-blue-300 mx-auto">
    <h1 class="flex flex-col items-center text-blue-800 text-2xl py-8">Update Course</h1>
</div>
<section>
    ...
    <form method="POST" action="{{ url('update') }}">
        @csrf
        <br><br>
        {{-- <b><h1>Update Course</h1></b><br> --}}
        <div>
            <x-jet-label for="courseid" value="{{ __('Course Id') }}" />
            <x-jet-input id="courseid" class="block mt-1 w-full" type="text" name="courseid" readonly value="{{$course_id}}" required autofocus autocomplete="courseid" /><br>
        </div>

        <div>
            <x-jet-label for="coursename" value="{{ __('Course Name') }}" />
            <x-jet-input id="coursename" class="block mt-1 w-full" type="text" name="coursename" value="{{$course_name}}" required autofocus autocomplete="coursename" /><br>
        </div>
        <div>
            <x-jet-label for="coursetime" value="{{ __('Course Duration') }}" />
            <x-jet-input id="coursetime" class="block mt-1 w-full" type="text" name="coursetime" value="{{$course_time}}" required autofocus autocomplete="coursetime" /><br>
        </div>
        <div>
            <x-jet-label for="coursecost" value="{{ __('Course Cost') }}" />
            <x-jet-input id="coursecost" class="block mt-1 w-full" type="text" name="coursecost" value="{{$course_cost}}" required autofocus autocomplete="coursecost" /><br>
        </div>

        {{--   START DATE--}}
        <div class="mt-4">
            <x-jet-label value="{{ __('Start Date') }}" />
            <select name="start_month"  value="{{$startmonth}}" class="inline-block mt-1 w-half">
                <option> </option>
            ...
            <select name="start_day"  value="{{$startday}}" class="inline-block mt-1 w-half">
                <option> </option>
            ...
            <select name="start_year"  value="{{$startyear}}" class="inline-block mt-1 w-half">
                <option> </option>
        ...
        <div class="mt-4">
            ...
            <select name="end_month" value="{{$Endmonth}}" class="inline-block mt-1 w-half">
                <option> </option>
                <option :value="old('January')" >January</option>
                <option :value="old('February')">February</option>
                <option :value="old('March')" >March</option>
            ...
            <select name="end_day"  value="{{$Endday}}" class="inline-block mt-1 w-half">
                <option> </option>
                <option :value="old('1')" >1</option>
                <option :value="old('2')" >2</option>
                <option :value="old('3')" >3</option>
            ...
            <select name="end_year" value="{{$Endyear}}" class="inline-block mt-1 w-half">
                <option> </option>
                <option :value="old('2003')" >2021</option>
                <option :value="old('2002')" >2022</option>
                <option :value="old('2001')" >2023</option>
        ...
        <div>
            ...
            <textarea type="textarea"  rows="10" cols="50" class="block mt-1 w-full" name="courseinfo" value="{{$course_info}}" autofocus placeholder="Enter course information here"></textarea>
            <br>
        </div>
        ...
        <div class="flex items-center mt-4 centertable">
            ...
            <a class="bt" href="{{url('/viewcourse')}}">{{ __('Cancel Update') }}</a>
        </div>
